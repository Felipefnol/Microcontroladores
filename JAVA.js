function AlteraRele1(){
    ...
    if(estado === "0"){
		...
		document.getElementById("botao").innerHTML="<a href='/?desligar' class='botao'>SALA - OFF</a>";
    } else {
        document.getElementById("estado").innerHTML="0";
        document.getElementById("rele").innerHTML="<div class='rele1_desligado'></div>";
        document.getElementById("botao").innerHTML="<a href='/?ligar' class='botao'>SALA - ON</a>";
    }
}
...
function AlteraRele2(){
    ...
    if(estado_2 === "0"){
		...
		document.getElementById("botao_2").innerHTML="<a href='/?2_desligar' class='botao_2'>QUARTO - OFF</a>";
    } else {
        document.getElementById("estado_2").innerHTML="0";
        document.getElementById("rele_2").innerHTML="<div class='rele2_desligado'></div>";
        document.getElementById("botao_2").innerHTML="<a href='/?2_ligar' class='botao_2'>QUARTO - ON</a>";
    }
}
